...
bool add_constraint(
  GMatr<double> & R, GMatr<double> & J, GVect<double> & d, int & iq, double & rnorm);
void delete_constraint(
  GMatr<double> & R, GMatr<double> & J, GVect<int> & A, GVect<double> & u, int n, int p, int & iq,
  int l);
...
double solve_quadprog(
  Eigen::MatrixXd & _G, Eigen::VectorXd & _g0, const Eigen::MatrixXd & _CE,
  const Eigen::VectorXd & _ce0, const Eigen::MatrixXd & _CI, const Eigen::VectorXd & _ci0,
  Eigen::VectorXd & _x)
{
...
double solve_quadprog(
  GMatr<double> & G, GVect<double> & g0, const GMatr<double> & CE, const GVect<double> & ce0,
  const GMatr<double> & CI, const GVect<double> & ci0, GVect<double> & x)
{
...
bool add_constraint(
  GMatr<double> & R, GMatr<double> & J, GVect<double> & d, int & iq, double & R_norm)
{
  int n = d.size();
#ifdef TRACE_SOLVER
...
inline void backward_elimination(
  const GMatr<double> & U, GVect<double> & x, const GVect<double> & y)
{
