...
#include "incwbc_ctrl/ContactSet/SingleContact.hpp"
#include "incwbc_ctrl/TaskSet/BodyOriTask.hpp"
#include "incwbc_ctrl/TaskSet/BodyPosTask.hpp"
//#include <WBC_Ctrl/TaskSet/BodyPostureTask.hpp>
#include "incwbc_ctrl/TaskSet/LinkPosTask.hpp"
  ...
  WBC_Ctrl<T>(model)
{
  ...
  _foot_contact[1] = new SingleContact<T>(&(WBCtrl::_model), linkID::FR);
  _foot_contact[0] = new SingleContact<T>(&(WBCtrl::_model), linkID::FL);
  _foot_contact[2] = new SingleContact<T>(&(WBCtrl::_model), linkID::HR);
  _foot_contact[3] = new SingleContact<T>(&(WBCtrl::_model), linkID::HL);

  _foot_task[1] = new LinkPosTask<T>(&(WBCtrl::_model), linkID::FR);
  _foot_task[0] = new LinkPosTask<T>(&(WBCtrl::_model), linkID::FL);
