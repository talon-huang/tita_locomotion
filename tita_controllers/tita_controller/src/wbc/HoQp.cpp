...
//   h_ = (matrix_t(
//           numDecisionVars_ + numSlackVars_, numDecisionVars_ + numSlackVars_)  // clang-format off
...
//   d_ =
//     (matrix_t(
//        2 * numSlackVars_ + numPrevSlackVars_, numDecisionVars_ + numSlackVars_)  // clang-format off
//             << zeroNvNx_, -eyeNvNv_,
...
//         stackedTasksPrev_.f_ - stackedTasksPrev_.d_ * xPrev_ + stackedSlackSolutionsPrev_,
//         fMinusDXPrev)
//          .finished();
// }
...
//   if (higherProblem_ != nullptr) {
//     stackedSlackVars_ =
//       Task::concatenateVectors(higherProblem_->getStackedSlackSolutions(), slackVarsSolutions_);
//   } else {
